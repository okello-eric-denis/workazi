...
const Header = () => {
   ...
   return (
      <>
         <header>
            <div className={sticky ? "sticky header__area" : "header__area "} id="header-sticky">
               <div className="container">
                  <div className="row align-items-center">
                     <div className="col-xxl-4 col-xl-2 col-lg-2 col-md-4 col-6">
                        <div className="logo">
                           <Link href='/'><a>
                           
                                 <img src="assets/img/logo/alternative.png" alt="logo" />
                           </a>
                           </Link> 
                        </div>
                     </div>
                     <div className="col-xxl-8 col-xl-8 col-lg-8 d-none d-lg-block">
                        <div className="main-menu">
                           <nav id="mobile-menu">
                              <ul>
                              <li><Link href="/"><a>Workazi</a></Link></li>
                              <li><Link href="/#CategoryArea"><a>Get a Service</a></Link></li>
                              <li><Link href="/#products"><a>Our Work</a></Link></li>
                              <li><Link href="/"><a>Get a Freelancer</a></Link></li>
