...
const  Branding= () => {
  ...
  const [checkbox, setCheckBox] = useState('Branding Design');
  const [categoryTag, setCategoryTag] = useState('Branding Design');
  // unique category
                      ...
                      <div className="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
                        <div className="product__thumb">
                          ...
                          <div className="product__thumb-btn transition-3">
                            ...
                            <a href="/product-details" onClick={() => handleProducDetails(item.id)} className="m-btn m-btn-7">
                              <Link href="/product-details">
                              View
                              </Link>
                            </a>
